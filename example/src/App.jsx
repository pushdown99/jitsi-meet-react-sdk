...
const App = () => {
    ...
    //IFRAME_DISABLED_TIMEOUT_MINUTES = 10;
    ...
    const handleJitsiIFrameRef2 = iframeRef => {
        ...
        iframeRef.style.border = '1px dashed #df486f';
    ...
    const generateRoomName = () => `JitsiMeetRoomNo 1`; //`JitsiMeetRoomNo${Math.random() * 100}-${Date.now()}`;
